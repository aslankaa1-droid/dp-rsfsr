    ...
    ru: {
      ...
      sections: {
        blocks: {
          ...
          c03_title: 'Финансовая модель', c03_desc: 'Свод показателей v5: стоимость бизнеса 63,0 млрд ₽ · ставка 29,58% · окупаемость 2,73 года · кратность для инвестора 18,4×. Имитационное моделирование, чувствительность, торнадо, терминальная стоимость по Гордону',
    ...
    en: {
      ...
      sections: {
        blocks: {
          ...
          c03_title: 'Financial Model', c03_desc: 'Figures v5: enterprise value RUB 63.0 bn · rate 29.58% · payback 2.73 years · investor multiple 18.4x. Monte Carlo, sensitivity, tornado, Gordon terminal value',
    ...
    fr: {
      ...
      sections: {
        blocks: {
          ...
          c03_title: 'Modèle financier', c03_desc: 'Indicateurs v5 : valeur d\'entreprise 63,0 Md ₽ · taux 29,58 % · récupération 2,73 ans · multiple investisseur 18,4×. Monte-Carlo, sensibilité, tornado, valeur terminale de Gordon',
    ...
    ar: {
      ...
      sections: {
        blocks: {
          ...
          c03_title: 'النموذج المالي', c03_desc: 'المؤشرات v5: قيمة المشروع 63.0 مليار ₽ · المعدل 29.58% · الاسترداد 2.73 سنة · مضاعف المستثمر 18.4×. مونتي كارلو، الحساسية، tornado، القيمة النهائية بطريقة غوردون',
