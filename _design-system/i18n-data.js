  ...
  window.CPFSR_I18N_DATA = {
    ...
    ru: {
      ...
      hero: {
        ...
        lead: 'Wedge через альянс институт развития / банк-партнёр / профильное министерство / оператор 779-П. Базовая оценка post-money 263 млн долл. США, окупаемость 2,73 года, стоимость бизнеса 63,0 млрд ₽. Двухстадийная архитектура: Pilot Light в действующем 259-ФЗ → целевой контур.',
      ...
      sections: {
        blocks: {
          ...
          c03_title: 'Финансовая модель', c03_desc: 'свод показателей v5: 63,0 / окупаемость 2,73 года / WACC 29,58 % / кратность 19× / Payback 2,73. Monte Carlo, sensitivity, tornado, multi-stage TV',
    ...
    en: {
      ...
      sections: {
        blocks: {
          ...
          c03_title: 'Financial Model', c03_desc: 'свод показателей v5: 63.0 / payback 2.73 yrs / WACC 29,58% / multiple 19x / Payback 2.8. Monte Carlo, sensitivity, tornado, multi-stage TV',
    ...
    fr: {
      ...
      sections: {
        blocks: {
          ...
          c03_title: 'Modèle financier', c03_desc: 'свод показателей v5 : 63,0 / amortissement 2,73 ans / WACC 29,58 % / multiple 19x / Payback 2,73. Monte Carlo, sensibilité, tornado, TV multi-étapes',
    ...
    ar: {
      ...
      sections: {
        blocks: {
          ...
          c03_title: 'النموذج المالي', c03_desc: 'свод показателей v5: 63,0 / فترة الاسترداد 2.73 سنة / WACC 29,58% / مضاعف 19x / Payback 2,73. Monte Carlo، الحساسية، tornado، TV متعدد المراحل',
