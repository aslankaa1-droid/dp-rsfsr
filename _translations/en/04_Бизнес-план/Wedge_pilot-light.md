...
## 1. What the wedge / pilot-light is
...
This regime does not require amendments to 86-FZ or the Budget Code; it fits entirely within the current 259-FZ + CBR Regulation 779-P.

---

## 2. Parameters of the wedge-pilot
...
## 3. Stakeholders of the wedge-pilot
...
## 4. Steps to launch the wedge-pilot

### Stage 0 — Preparatory (T+0 to T+3 months)

1. Incorporation of the JSC "CPFSR" (see `02_Юридический_фундамент/Учреждение_АО_оператора_и_РКН.md`).
2. Appointment of 779-P-mandated officers.
3. Submissions to Rospatent / Roskomnadzor / Rosfinmonitoring.

### Stage 1 — Memo wrapper and champion search (T+3 to T+9 months)
...
### Stage 3 — Pilot phase (T+15 to T+24 months)

1. **Connection of the municipal base of the pilot region** (50–100 objects).
2. **First cycle of targeted DFA issuance** on the basis of the municipal collateral pool.
3. **Targeted funding through VEB.RF** (Project Finance Factory) under regional guarantees.
4. **Financing of a national project** (for example, refurbishment of utility facilities or construction of social housing).
5. **Accounting of operations** within the current legal architecture (without amendments to 86-FZ).

### Stage 4 — Scaling (T+24 to T+36 months)

1. **Expansion to 3–5 regions** (replication of the model).
2. **Inclusion of a second collateral class** (regional commercial real estate).
3. **Connection of a second partner bank** (diversification).
4. **Connection of a second insurance company**.
5. **Preparation of a consolidated inter-agency position** (CBR + Ministry of Finance + Ministry of Economic Development + VEB.RF) for the horizon entry into the Bank of Russia with a targeted-funding construction.

### Stage 5 — Horizon phase (T+36+ months)

1. Through the accumulated 18–24-month track record of the wedge-pilot — **enter the Bank of Russia with a consolidated inter-agency position**.
2. Lobbying of the package of four federal laws (86-FZ, 259-FZ, Budget Code, Civil Code) — Ministry of Digital Development + Ministry of Finance + CBR + Ministry of Economic Development.
3. Sub-legislative acts, a CBR Directive, a joint order of Ministry of Finance / CBR / Ministry of Digital Development / Rosreestr / Federal Treasury.
4. Full-scale launch with the targeted-funding construction.

---

## 5. Financial logic of the wedge-pilot

### 5.1. Unit economics of the pilot, Year 1 (2027)

| Indicator | Value |
|---|---:|
| Collateral pool | 50 objects × RUB 100M = **RUB 5 bn** |
| Issued DFA | RUB 5 bn nominal |
| Issuance commission (0.5%) | RUB 25M |
| Annual servicing commission (0.3% of stack) | RUB 15M |
| Platform fee for valuation/insurance (0.15%) | RUB 7.5M |
| Appraisal services (0.8% of volume) | RUB 40M |
| **Full Year-1 revenue** | **≈ RUB 87.5M** |
| Year-1 OpEx | RUB 70M |
| Year-1 EBITDA | RUB 17.5M |
| **Year-1 EBITDA margin** | **20%** |

### 5.2. Scaling of the pilot

| Year | Regions | Collateral pool, RUB bn | Revenue, RUB bn | EBITDA margin |
|---|---:|---:|---:|---:|
| 2027 (pilot) | 1 | 5 | 0.09 | 20% |
| 2028 (expansion) | 3 | 22 | 0.42 | 40% |
| 2029 (expansion) | 5 | 80 | 1.8 | 55% |
| 2030 (horizon phase) | 12 | 400 | 8.4 | 65% |
...
## 6. Competitive analysis of the wedge-pilot

Audit point D-2 noted competitors not reflected in the DD. The wedge strategy co-opts them:
...
## 7. Defence against the mandate conflict

The principal advantage of the wedge: **the project does not approach the CBR with a request for issuance**.

| Argument against a CBR mandate | Wedge response |
|---|---|
| The CBR has no powers for targeted issuance (Articles 4, 22, 75 of 86-FZ) | In the wedge — targeted funding through VEB.RF / Treasury; no amendments to 86-FZ required |
...
## 8. Key success criteria of the wedge-pilot

| Criterion | Value | Timing |
|---|---|---|
| JSC incorporation + officer appointments | Per 779-P | T+2 months |
...
| Consolidated inter-agency position for entering the CBR with the legislative package | Signed | T+30 months |
...
**Prepared:** within the remediation of RED flags of the composite audit; reconciled with the financial model and the legal foundation.
