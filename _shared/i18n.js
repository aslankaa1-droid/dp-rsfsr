  ...
  const DICT = {
    ru: {
      ...
      hero: {
        ...
        lead: "Операторская платформа выпуска ЦФА под залог имущества граждан и организаций. Целевое фондирование национальных и инфраструктурных проектов в pilot-light режиме 2028–2029 — через Фабрику проектного финансирования ВЭБ.РФ и Федеральное казначейство; Банк России — надзорный регулятор по ст. 4 86-ФЗ.",
    ...
    ar: {
      brand: { name: "DP RSFSR", tagline: "الخدمة الروسية لتمويل التنمية الاجتماعية" },
      nav: {
      ...
      econ: {
        eyebrow: "الاقتصاد",
        title: "صافي القيمة الحالية 51.2 مليار روبل برأس مال 1.335 مليار روبل (WACC 29,58%)",
        lead: "نموذج لمدة 10 سنوات: استرداد خلال 2.73 سنة في السيناريو الأساسي (WACC 29,58%)؛ حتى السيناريو المتحفظ يعطي صافي قيمة حالية ≈ 22 مليار روبل. مضاعف 12×.",
